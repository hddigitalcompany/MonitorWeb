  ...
  return (
    <section className="mb-6">
      ...
      {dados.aviso ? (
        ...
        <p className="text-sm text-muted">Não encontramos delegacias, hospitais ou bombeiros cadastrados no mapa desta cidade.</p>
      ) : (
        <>
          <p className="mb-2 text-xs text-muted">{dados.locais.length} locais de apoio · Toque para ver no mapa</p>
